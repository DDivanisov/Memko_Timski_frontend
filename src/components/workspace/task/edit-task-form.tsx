...
export default function EditTaskForm({ task, onClose }: { task: TaskType; onClose: () => void }) {
  ...
  const formSchema = z.object({
    ...
    status: z.enum(Object.values(TaskStatusEnum) as unknown as [keyof typeof TaskStatusEnum]),
    priority: z.enum(Object.values(TaskPriorityEnum) as unknown as [keyof typeof TaskPriorityEnum]),
    type: z.enum(Object.values(Type) as unknown as [keyof typeof Type]),
