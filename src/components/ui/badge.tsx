  ...
  "inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        [Type.BUG]: "bg-red-100 text-red-600",
        [Type.FEATURE]: "bg-yellow-100 text-yellow-600",
        [Type.IMPROVEMENT]: "bg-green-100 text-green-600",
        [Type.SUB_TASK]: "bg-yellow-100 text-yellow-600",
        [Type.TASK]: "bg-yellow-100 text-yellow-600",
      },
    },
    defaultVariants: {
      variant: "default",
